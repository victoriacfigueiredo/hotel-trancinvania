...
And O hotel "Jardins" não possui nenhuma promoção
...
And O hotel "Jardins" permanece com seu valor original de "R$ 1500,00" a noite

Scenario 4: Cadastrar uma promoção em todas as reservas publicadas

Given Eu estou logada como "Hoteleiro" com o login "Maria"  e a senha "let123"
And Eu estou na página "Reservas publicadas"
And O hotel "Flores" está nas reservas publicadas com o valor de "R$ 1300,00" a noite
And O hotel "Jardins" está nas reservas publicadas com o valor de "R$ 1500,00" a noite
And O hotel "Campos" está nas reservas publicadas com o valor de "R$ 1400,00" a noite
...
And Eu vejo o hotel "Flores" com o valor atualizado para "R$ 1040,00" a noite
And Eu vejo o hotel "Jardins" com o valor atualizado para "R$ 1200,00" a noite
And Eu vejo o hotel "Campos" com o valor atualizado para "R$ 1120,00" a noite
...
Given Eu estou logada como "Hoteleiro" com o login "Maria"  e a senha "let123"
And Eu estou na página "Reservas publicadas"
And O hotel "Flores" está com uma promoção de "20%" cadastrada com o valor promocional de "R$ 1040,00"
When Eu seleciono "Editar promoção" no hotel "Flores"
And Eu altero o desconto para "60%"
Then Eu vejo uma mensagem de confirmação
And Eu vejo a nova promoção no hotel "Flores" com o valor da noite atualizado para "R$ 520,00" na página "Reservas publicadas" 
